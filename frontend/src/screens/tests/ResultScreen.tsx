...
import ResultModals from '../../components/tests/ResultModals';
      ...
      <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
        ...
        <View style={styles.header}>
          ...
          <View style={[styles.headerSide, { alignItems: 'flex-end' }]}>
            <TouchableOpacity onPress={handleDonePress} activeOpacity={0.7} style={styles.doneBtn}>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.bottomSection}>
            ...
            <Image source={uiConfig.catImage} style={styles.catImage} />
          </View>
        </View>
      </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 16, fontFamily: 'Baloo2_700Bold', color: '#000000', textAlign: 'center' },
  doneBtn: { paddingLeft: 10 },
  doneText: { fontSize: 18, fontFamily: 'Baloo2_700Bold', color: '#FFFFFF' },
  content: {
    flex: 1,
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  categoryText: { fontSize: 24, fontFamily: 'Baloo2_700Bold', color: '#000000' },
  bottomSection: { width: '100%', alignItems: 'center', paddingBottom: 10 },
  chatWrapper: { position: 'relative', width: width * 0.72, zIndex: 2 },
  chatBubble: {
    borderWidth: 8,
    borderColor: '#000000',
    borderRadius: 28,
  ...
  chatMessage: { fontSize: 15, fontFamily: 'Baloo2_700Bold', color: '#000000', textAlign: 'center', lineHeight: 26 },
  catImage: {
    width: 140,
    height: 140,
    resizeMode: 'contain',
